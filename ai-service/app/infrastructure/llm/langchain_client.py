...
class LangChainClient:
    ...
    def _build_prompt(
        ...
        return (
            ...
            f"Nguon kien thuc:\n{context}\n\n"
            "Yeu cau cau tra loi:\n"
            "- Toi da 5 dong ngan, moi dong duoi 22 tu.\n"
            "- Mo dau bang 1 cau chot y ngan.\n"
            "- Giai thich truc tiep y nghia/cach dung, khong viet thanh bai giang dai.\n"
            ...
            "- Neu co tu vung tieng Nhat, chi chon toi da 2 muc that lien quan.\n"
