...
from app.api.v1 import assessment_controller, planner_controller, pronunciation_controller, tutor_controller
...
app.include_router(pronunciation_controller.router)
