...
16. **Frontend portal split** — Learner app và Admin console phải tách route/layout rõ ràng: learner ở `/learner`, admin ở `/admin`. Không trộn công cụ quản trị vào trang người học; admin route phải có role guard trước khi gọi API quản trị.
